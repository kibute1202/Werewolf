...
public class InGameGrandmotherSelectPlayerAdapter extends RecyclerView.Adapter<InGameGrandmotherSelectPlayerAdapter.MyViewHolder> {
    ...
    public InGameGrandmotherSelectPlayerAdapter(Context mContext, List<Player> playerList) {
...
//                .show();
    ...
    private void checkSelect(int position) {
        ...
        if (playerList.get(position).isWolfBites()) {
            ...
            if (getNumberSelect() < AppController.getInstance().getPrefManager().getNumberGrandmotherSelect()) {
                playerList.get(position).setWolfBites(true);
            } else {
                new MaterialDialog.Builder(mContext)
                        .title(resources.getString(R.string.hunter_select_error_title))
                        .content(resources.getString(R.string.hunter_select_error_content) + " " + AppController.getInstance().getPrefManager().getNumberGrandmotherSelect())
                        .positiveText(resources.getString(R.string.agree))
                        .show();
            }
        }
