...
public class InGameCupidSelectPlayerAdapter extends RecyclerView.Adapter<InGameCupidSelectPlayerAdapter.MyViewHolder> {
    ...
    public InGameCupidSelectPlayerAdapter(Context mContext, List<Player> playerList) {
    ...
    private void checkSelect(int position) {
        ...
        if (playerList.get(position).isWolfBites()) {
            ...
            if (getNumberSelect() < AppController.getInstance().getPrefManager().getNumberCupidSelect()) {
                playerList.get(position).setWolfBites(true);
            } else {
                new MaterialDialog.Builder(mContext)
                        .title(resources.getString(R.string.hunter_select_error_title))
                        .content(resources.getString(R.string.hunter_select_error_content) + " " + AppController.getInstance().getPrefManager().getNumberCupidSelect())
                        .positiveText(resources.getString(R.string.agree))
                        .show();
            }
        }
