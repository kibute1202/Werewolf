...
public class ThreeBrother extends Fragment implements OnClickListener {
    private String TAG = ThreeBrother.class.getSimpleName();
    private View view;
    ...
    private void initViews() {
        role = ListRoles.getInstance().getListRolesUsing().get(ListRoles.getInstance().getRoleInListShuffle(ListRoles.FLAG_THREE_BROTHERS));
