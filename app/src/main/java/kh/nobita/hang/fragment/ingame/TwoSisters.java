...
public class TwoSisters extends Fragment implements OnClickListener {
    private String TAG = TwoSisters.class.getSimpleName();
    private View view;
    ...
    private void initViews() {
        role = ListRoles.getInstance().getListRolesUsing().get(ListRoles.getInstance().getRoleInListShuffle(ListRoles.FLAG_TWO_SISTERS));
